...
差異項 | 小麥注音 (2.4.1) | 威注音 (2.9.4 SP2) | 補記
-- | -- | -- | --
...
態械引擎 | 多型別狀態策略設計模式<br />無專有內部資料型別 | 單結構狀態策略設計模式<br />有專有內部資料型別 | 威注音的設計更易於維護、且使用起來更加靈活。
...
-- | -- | -- | --
支援注音排列種類 | 大千傳統、倚天傳統、倚天26、許氏、IBM | 大千傳統、倚天傳統、IBM、神通、(偽)精業、倚天26、酷音大千26 、許氏、星光 | 下述排列為動態注音排列：倚天26、酷音大千 26 、許氏、星光
