...
以下列出唯音自自立分支後至 v4.1.0 之關鍵里程碑（日期以實際開發活動階段為準，非全部為正式發佈日）:
...
這篇技術白皮書主要是為了讓部分使用者明白小麥注音與唯音至少有哪些技術上與產品功能上的不同。至於 Megrez 組句引擎與 Gramambular 組句引擎的差異，請洽《[Homa vs. MegrezNT vs. Gramambular2 Whitepaper](./WHITEPAPER_Homa_MegrezNT_Gramambular2.md)》一文。

P.S.: IMK 選字窗一度受唯音支援，但因為其利用方式太複雜不利於唯音輸入法長遠發展的原因、而在唯音 3.5.4 版內遭到了移除。

## 總括概述

差異項 | 小麥注音 (2.9.3) | 唯音 (4.1.0) | 補記
-- | -- | -- | --
