...
|-------|----|----|----|----|
| macOS (10.13.4) | [GitHub](https://github.com/vChewing/vChewing-macOS/releases), [Gitee](https://gitee.com/vChewing/vChewing-macOS/releases) | [GitHub](https://github.com/vChewing/vChewing-macOS/wiki/%E6%9B%B4%E6%96%B0%E5%B1%A5%E6%AD%B7), [GitCode](https://gitcode.net/vChewing/vChewing-macOS/-/wikis/%E6%9B%B4%E6%96%B0%E5%B1%A5%E6%AD%B7) | [GitHub](https://github.com/vChewing/vChewing-macOS/), [Gitee](https://gitee.com/vChewing/vChewing-macOS/) | 3.5.0 SP1 (Jun 17, 2023) |
| macOS (10.9 - 10.12) | [GitHub](https://github.com/vChewing/vChewing-OSX-Legacy/releases), [Gitee](https://gitee.com/vChewing/vChewing-OSX-Legacy/releases) | 參見下載頁面 | [GitHub](https://github.com/vChewing/vChewing-OSX-Legacy/), [Gitee](https://gitee.com/vChewing/vChewing-OSX-Legacy/) | 0.5.22 SP1 (Jun 17, 2023) |
...
> **注**：威注音輸入法有支援 macOS 14 Sonoma Beta 1。如果今後的 macOS 14 測試版的使用者們發現威注音輸入法的 IMK 選字窗有無法使用的故障的話，歡迎**[電郵提報](./BUGREPORT.md)**。

部分近期主打更新內容概要：

- [3.5.0 SP1] 支援 CIN v2.1 標準；另有些許故障修正。
