...
- 體驗：[所有發行版] 新增了「狂拼模式」，可在唯音輸入法偏好設定的「行為設定」頁面啟用。
  ...
  - 啟用後，連續敲擊拼音字母即可組句，無需逐音節敲聲調或空格鍵確認。
    ...
    - 預覽期間原始拼音改以提示框顯示（候選窗顯示時自動讓位、避免重疊）。狂拼預覽中按空格會將當前讀音插入組字器（不再兼任候選輪替）；注拼槽尚有未完成拼音時按 Enter 亦僅固化當前讀音（或就地確認高亮候選）並停留於組字狀態，待注拼槽清空後再按 Enter 才遞交整句。
...
vChewing-macOS-4.6.3-signed-alternative.zip (個人用戶推薦使用該安裝包)
4d76ca1302912f3e440b75891174affc928d4728bce9459a4617ae3b23243f98

vChewing-macOS-4.6.3-signed.pkg (僅建議 Homebrew 或企業電腦藉由終端機批次部署時使用，部署時請勿使用管理員權限)
40560f5c68fcc4fd3250d87dfb9004a78b866a64d70e1ed644d4a1c84232eb6a

vChewingAqua-4.6.3-signed.zip (macOS 10.09 ~ 12.x 專用)
0dd92a41e14a7ff6bf857649a115b5a4773a7f20fd4939d8028cf7a93f5c2438
