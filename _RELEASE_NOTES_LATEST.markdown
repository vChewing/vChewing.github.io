...
4. 如果您在使用 macOS 14 Sonoma 及之後的版本的系統的話，請勿使用唯音 3.5.3 及之前的版本，因為這些版本可能會觸發系統內的某些缺陷、導致整個系統畫面失去響應。此外，如果您有將使用者辭典目錄放在任何網路硬碟的話，請勿使用唯音 4.3.6 及之前的版本，否則可能會在這些網路硬碟因為 DNS 故障陷入同步失敗的過程時出現「輸入法卡死整個系統」的情況。
...
vChewing-macOS-4.4.4-signed.pkg (新電腦安裝時建議使用)
fa20fd63df940fe6810fdf34c153f1d6f9ea4a0efb4dad23582dbc3105900132

vChewing-macOS-4.4.4-signed-alternative.zip (當且僅當 pkg 安裝包無效時的備選安裝方法)
c61816ea677fd7079d44df3e60793667fc15bb7d32fc21255b146ceb50c3b89b

vChewingAqua-4.4.4-signed.zip (macOS 10.09 ~ 12.x)
b0b489fc8ebb7340f861008645f77e6ee4e2810c85515395ef5837326fbb5e78
